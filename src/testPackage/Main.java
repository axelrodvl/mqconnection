...
public class Main {
    public static void main(String[] args) {
        ...
        XMLMessage xmlMessage = new XMLMessage(xmlString);
        
        xmlMessage.replaceXpathValue("/TestingMQStubInput/ID", "MQC_new");
        
        mqc.newStaticConnection("MQSTUB.IN", "MQSTUB.OUT");
        
        mqc.makeTransactionStaticConnection(xmlMessage);
        mqc.makeTransactionStaticConnection(xmlMessage);
        mqc.makeTransactionStaticConnection(xmlMessage);
        mqc.makeTransactionStaticConnection(xmlMessage);
        mqc.makeTransactionStaticConnection(xmlMessage);
